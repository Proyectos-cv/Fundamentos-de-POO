#class error1(Exception):
    #def __init__(self):
        #print "informacion insuficiente del producto"
#class error2(Exception):
    #def __init__(self):
        #print"datos faltantes sobre el cliente"
#class error3(Exception):
    #def __init__(self):
        #print"todos los espacios sobre el provedor deben estar llenos"
#class error4(Exception):
    #def __init__(self):
        #print"la empresa necesita todos los datos que se solicitan del empleado"
from Tkinter import *

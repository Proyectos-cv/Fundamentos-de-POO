...
from excepciones import EspacioBlanco, Negativos
class Productos():
#class Productos(DatosComunes,Funciones):
    def __init__(self):
        self.venProdu =Toplevel()
        self.venProdu.geometry("1200x750")
        ...
        self.nombreProducto = StringVar()
        self.cajanomProducto = Entry(self.venProdu, textvariable=self.nombreProducto)
        ...
        self.PrecioCompraProducto = DoubleVar()
        self.cajaPrecioCompraProducto = Entry(self.venProdu, textvariable=self.PrecioCompraProducto)
        ...
        self.precioVentaProducto = DoubleVar()
        self.cajaprecioVentaProducto = Entry(self.venProdu, textvariable=self.precioVentaProducto)
        ...
        self.cajamarca = Entry(self.venProdu, textvariable=self.marca)
        ...
        self.cajacantidad = Entry(self.venProdu, textvariable=self.cantidad)
        self.cajacantidad.place(x=250, y=350)
        lblcodigo = Label(self.venProdu, text="Codigo", bg='orange')
        lblcodigo.place(x=100, y=400)
        self.codigo = IntVar()
        self.cajacodigo = Entry(self.venProdu, textvariable=self.codigo)
        ...
        self.descripcionProducto= StringVar()
        self.cajadescripcionProducto = Entry(self.venProdu, textvariable=self.descripcionProducto)
        ...
        self.fechaCaducidad = StringVar()
        self.cajafechaCaducidad = Entry(self.venProdu, textvariable=self.fechaCaducidad)
        self.cajafechaCaducidad.place(x=250, y=500)
        btnagregar = Button(self.venProdu, text="Guardar", bg='cyan', command=self.agregar)
        btnagregar.place(x=500, y=600)
        btneliminar = Button(self.venProdu, text="Eliminar", bg='cyan', command=self.baja)
